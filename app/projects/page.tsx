        ...
        <div className="container-custom">
          ...
          <div className="flex flex-wrap items-center gap-4 mb-16 animate-fade-up">
            ...
            {["All", "Leadership", "Community Service", "Club Service", "Environment", "Education"].map((tag) => (
              <button 
                key={tag} 
                className={`px-6 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.1em] transition-all border ${
                  tag === "All" 
                ...
                >
                  <div className="relative h-72 overflow-hidden">
                    ...
                    <div className="absolute top-6 left-6 flex flex-col gap-2 z-20">
                      ...
                      <div className={`px-4 py-1.5 text-[9px] font-black uppercase tracking-widest rounded-full shadow-sm backdrop-blur-md border ${
