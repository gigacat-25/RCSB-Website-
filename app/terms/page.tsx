            ...
            <div className="container-custom max-w-4xl">
                ...
                <div className="bg-white p-10 md:p-16 rounded-[3rem] shadow-xl shadow-slate-200/50 outline-none">
                    ...
                    <div className="prose prose-lg prose-slate max-w-none text-brand-gray">
                        ...
                        <p>
                            Welcome to the website of Rotaract Club of Swarna Bengaluru. By accessing our website (rotaractswarnabengaluru.in), you are agreeing to comply with these terms of service, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws.
                        </p>
                        ...
                        <div className="mt-12 p-6 bg-brand-gold/5 rounded-2xl border border-brand-gold/10">
                            ...
                            <p className="text-sm">
                                ...
                                <strong><a href="mailto:rota.rcbs@gmail.com" className="text-brand-blue hover:text-brand-azure hover:underline transition-colors mt-1 inline-block">ROTA.RCBS@GMAIL.COM</a></strong>
                            </p>
                        </div>
                    </div>
                </div>
