        ...
        {events.length > 0 && (
          <div className="mb-32">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
              ...
              <Link href="/projects" className="group flex items-center gap-4 text-brand-blue font-black uppercase tracking-[0.2em] text-[10px] hover:text-brand-azure transition-colors">
                ...
                >
                  <Link href={`/projects/${event.slug}`} className="flex flex-col md:flex-row w-full">
                    ...
                    <div className="md:w-3/5 p-10 flex flex-col justify-center bg-white">
                      <div className="flex items-center gap-3 text-brand-azure text-[10px] font-black uppercase tracking-[0.2em] mb-4 font-sans">
                      ...
                      <p className="text-brand-gray/60 text-sm line-clamp-2 italic font-light leading-relaxed font-sans">
                        {event.description}
                      </p>
                      <div className="mt-8 flex items-center gap-2 text-brand-blue font-black text-[10px] uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity font-sans">
                        See Invitation &rarr;
                      </div>
                    </div>
                  </Link>
        ...
        {blogs.length > 0 && (
          <div>
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
              ...
              <Link href="/blogs" className="group flex items-center gap-4 text-brand-blue font-black uppercase tracking-[0.2em] text-[10px] hover:text-brand-cranberry transition-colors">
                ...
                >
                  <Link href={`/blogs/${blog.slug}`} className="flex flex-col h-full">
                    ...
                    <div className="flex-1 px-4 flex flex-col">
                      <span className="text-brand-azure text-[10px] font-black uppercase tracking-[0.3em] mb-4 block font-sans">
                        {blog.category}
                      </span>
                      <h4 className="text-2xl font-heading font-black text-brand-blue mb-4 group-hover:text-brand-azure transition-colors line-clamp-2">
                        {blog.title}
                      </h4>
                      <p className="text-brand-gray/60 text-sm line-clamp-3 leading-relaxed font-light mb-6 font-sans">
                        {blog.description}
                      </p>
                      <div className="w-12 h-1 bg-slate-100 group-hover:w-full group-hover:bg-brand-gold transition-all duration-500 mt-auto" />
                      ...
                      <div className="mt-6 flex items-center justify-between font-sans">
                        ...
                        <div className="w-10 h-10 rounded-full border border-slate-100 flex items-center justify-center group-hover:bg-brand-blue group-hover:border-brand-blue group-hover:text-white transition-all duration-300 transform group-hover:translate-x-2">
