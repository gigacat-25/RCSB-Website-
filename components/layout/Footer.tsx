    ...
    <footer className="bg-slate-950 text-white pt-24 pb-12 relative overflow-hidden">
      ...
      <div className="container-custom">
        ...
        <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex flex-col md:flex-row items-center gap-4 text-[11px] font-black uppercase tracking-[0.2em] text-white/30 text-center md:text-left flex-wrap justify-center md:justify-start">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <a href="https://www.facebook.com/rotaractswarnabengaluru/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#1877F2] hover:border-[#1877F2] transition-all duration-300 text-white group">
              <FaFacebookF className="w-4 h-4 group-hover:scale-110 transition-transform" />
            </a>
            <a href="https://www.instagram.com/rotaract_swarnabengaluru" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#e6683c] hover:to-[#bc1888] hover:border-transparent transition-all duration-300 text-white group">
              <FaInstagram className="w-4.5 h-4.5 group-hover:scale-110 transition-transform" />
            </a>
            <a href="https://www.linkedin.com/company/rotaract-club-of-swarna-bengaluru/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#0077b5] hover:border-[#0077b5] transition-all duration-300 text-white group">
              <FaLinkedinIn className="w-4 h-4 group-hover:scale-110 transition-transform" />
            </a>
            <a href="https://www.youtube.com/channel/UCE4XQBKSjPs8rj5xyH6FOxA" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#FF0000] hover:border-[#FF0000] transition-all duration-300 text-white group">
              <FaYoutube className="w-4.5 h-4.5 group-hover:scale-110 transition-transform" />
            </a>
            <a href="https://x.com/RCSwarnaB" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white hover:border-white transition-all duration-300 text-white hover:text-black group">
